...
module.exports = createFactory
  ...
  handleFacebookUploadPhoto: (e) -> @refs.fileUploader.pickFile()
      ...
      d.div {className: 'manage-photos'}, _.flatten([
        unless @props.store.getPhotos().length > 0
          ...
          [ d.div {className: 'buttons'}, [
            ...
            d.div {className: 'buttons'},
              d.Button {className: 'square facebook-upload-photo', onClick: @handleFacebookUploadPhoto}, "Upload Facebook Photos"
