    ...
    d.div {className: 'outer-container'}, d.div {className: 'inner-container'},
      ...
      d.div {className: 'profile'}, [
        d.div {className: 'photos-and-info'}, [
          ...
          d.div {className: 'name-profile-info'}, [
...
#          )...
        ...
        d.div {className: 'like-and-message'}, [
          d.div {className: 'like-part'},
            d.div {className: 'like-inner-div'},
              d.Glyph(glyph: 'heart')
              d.span {className: 'like-span'}, " Like"
          d.div {className: 'message-part'},
            d.div {className: 'message-inner-div'},
              d.Glyph(glyph: 'envelope')
              d.span {className: 'message-span'}, " Message"
        ]...
